---
title: "NanoString GeoMx Digital Spatial Profiling/nTenX Spatial Transcriptomics"
...
#remember to save the images that will go in the document in an 'images' folder that is located in the same directory as this document.
```
